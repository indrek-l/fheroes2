...
enum SaveFileFormat : uint16_t
{
    ...
    FORMAT_VERSION_1154_RELEASE = 10037,
    FORMAT_VERSION_1153_RELEASE = 10036,
    FORMAT_VERSION_1152_RELEASE = 10035,
    FORMAT_VERSION_1151_RELEASE = 10034,
    ...
    CURRENT_FORMAT_VERSION = FORMAT_VERSION_1154_RELEASE
};
